...
<div
	class="fixed bottom-6 left-1/2 z-20 flex max-w-[95vw] -translate-x-1/2 items-center gap-1.5 overflow-visible rounded-xl border border-[#27272a] bg-[#18181b] px-2.5 py-2 shadow-2xl backdrop-blur-md select-none"
>
	...
	<div class="mx-0.5 h-5 w-px shrink-0 bg-[#27272a]"></div>
