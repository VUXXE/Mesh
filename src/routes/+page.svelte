...
>
	<a
		...
		class="fixed top-4 right-4 z-20 flex items-center gap-2 rounded-full border border-(--surface-2) bg-(--surface-1) py-1.5 pr-3.5 pl-3 shadow-lg backdrop-blur-md transition-all select-none hover:scale-105 hover:border-[#6366f1] focus:outline-none"
	...
	>
		...
		<!-- Footer -->
		<div class="mt-8 border-t border-(--surface-2) pt-6 text-center text-[11px] text-(--ink-3)">
			<a
				href="https://github.com/VUXXE/Mesh"
				target="_blank"
				rel="noopener noreferrer"
